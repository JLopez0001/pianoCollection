"""
Django settings for pianocollection project.
...
SECRET_KEY = 'django-insecure-cs4%-b&86p^*ru4#oaa^9n1%dcq!&r9bv*b_%h-d127w9&%m_w'
...
ROOT_URLCONF = 'pianocollection.urls'
...
WSGI_APPLICATION = 'pianocollection.wsgi.application'
